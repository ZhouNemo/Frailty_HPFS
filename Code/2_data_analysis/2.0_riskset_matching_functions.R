...
#   the datasets generated by 2.1-2.5.
#
# Units:
...
#   cancer_index_dateca is the canonical earliest cancer date produced by
#   Code/1_data_cleaning/7.4_cancer_subtypes.R; raw cancer_dateca is retained
#   upstream for audit and is not used for analytic timing.
# =============================================================================
...
build_riskset_matched_long <- function(input_path,
  ...
  if (is.null(index_age_scaling)) {
    ...
    scaling_source <- "reused from primary overall-cancer matched cohort"
  }
