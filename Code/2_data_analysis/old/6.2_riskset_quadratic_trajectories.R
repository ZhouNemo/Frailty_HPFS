...
# Script:  6.2_riskset_quadratic_trajectories.R
# Author:  Nemo Zhou
# Date started:      2026-06-28
# Date last updated: 2026-06-29
#
# Purpose:
#   Fits quadratic frailty trajectories for the high-burden versus low/moderate-
#   burden risk-set matched cohorts. Risk-set matching is no longer created in
#   this script; run 2.1 first to overwrite the matched cohort dataset.
#
# Input:
...
run_quadratic_trajectory_analysis(
  ...
  analysis_title = "Frailty Trajectories by Cancer Burden (Risk-Set Matched)",
  out_fig = "6.2_quadratic_trajectories_with_CI.png",
  out_coef = "6.2_quadratic_fixed_effects_CI.csv",
  out_pred = "6.2_quadratic_predicted_trajectories.csv",
