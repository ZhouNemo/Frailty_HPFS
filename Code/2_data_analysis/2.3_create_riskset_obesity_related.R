...
# Script:  2.3_create_riskset_obesity_related.R
# Author:  Nemo Zhou
...
#   for obesity-related cancer versus cancer-free control trajectory analyses.
#   Obesity-related status is read from the canonical `is_obesity_cancer` flag
...
#   Data/riskset_matched_obesity_exact_cycle_long.rds (S7)
# =============================================================================
...
output_path <- file.path(data_dir, "riskset_matched_obesity_long.rds")
exact_cycle_output_path <- file.path(data_dir, "riskset_matched_obesity_exact_cycle_long.rds")
...
cohort_levels <- c("Obesity-Related Cancer Cohort")
classify_fn <- function(pl) {
  ifelse(coalesce0(pl$is_obesity_cancer) == 1,
...
matched_result <- build_riskset_matched_long(
  ...
  classification_vars = "is_obesity_cancer",
...
save_riskset_match(matched_result, output_path, "Obesity-related risk-set cohort")
...
save_riskset_match(
  ...
  "Obesity-related exact-cycle risk-set cohort (S7)"
)
