...
# Script:  4.2_GLME_smoking_related.R
# Author:  Nemo Zhou
...
#   smoking-related cancer versus cancer-free control risk-set matched cohort.
...
#
#   Risk-set matching is NOT created here; run 2.2 first to build the matched data.
#
# Input:
#   Data/riskset_matched_smoking_long.rds   (from 2.2_create_riskset_smoking_related.R;
#   must pass Gate G4 and match its provenance hash)
# Outputs: 4.2_eventstudy_* and 4.2_spline_* CSV summaries in Results/cancer/data,
#   plus Results/cancer/visuals/4.2_GLME_figures.pdf containing the three figures.
# =============================================================================
...
run_eventstudy_spline_analysis(
  ...
  out_prefix     = "4.2",
  analysis_title = "Frailty Event-Study by Smoking-Related Cancer (Risk-Set Matched)",
